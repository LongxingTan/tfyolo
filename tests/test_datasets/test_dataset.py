...
#             self.data_reader.iter, output_types=(tf.string, tf.float32, tf.float32, tf.float32)
#         )
...
#             preds = batch_non_max_suppression(predictions, conf_threshold=0.4, iou_threshold=0.35)
